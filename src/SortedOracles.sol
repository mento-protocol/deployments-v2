...
import "node_modules/@celo/contracts/stability/interfaces/ISortedOracles.sol";
import "node_modules/@celo/contracts/stability/interfaces/ISortedOraclesInitializer.sol";
import "node_modules/@celo/contracts/common/interfaces/ICeloVersionedContract.sol";
import "node_modules/@celo/contracts/stability/interfaces/IBreakerBox.sol";

import "node_modules/@celo/contracts/common/FixidityLib.sol";
import "node_modules/@celo/contracts/common/Initializable.sol";
import "node_modules/@celo/contracts/common/linkedlists/AddressSortedLinkedListWithMedian.sol";
import "node_modules/@celo/contracts/common/linkedlists/SortedLinkedListWithMedian.sol";
import "node_modules/@celo/contracts/0.8/common/interfaces/IOracle.sol";
    ...
    Initializable
{
    ...
    event EquivalentTokenSet(
        address indexed token,
        address indexed equivalentToken
    );
    ...
    function setEquivalentToken(
        ...
        require(
            equivalentToken != address(0),
            "equivalentToken address cannot be 0"
        );
    ...
    function setBreakerBox(IBreakerBox newBreakerBox) public onlyOwner {
        require(
            address(newBreakerBox) != address(0),
            "BreakerBox address must be set"
        );
